...
import RoleManagement from "./Dashboard/RoleManagement.js";
    ...
    return (
        <div className="main px-lg-4 px-md-4">
            ...
            <div className="body d-flex py-lg-3 py-md-2">
                ...
                <Route exact path={`${process.env.PUBLIC_URL}/manage-roles`} component={RoleManagement} />
                <Route exact path={`${process.env.PUBLIC_URL}/manage-users`} component={UserManagement} />
